$(document).ready(function(){
  ...
  $(document).on("blur","#editar_product_nombre",function(){validator("empty",$(this).attr('id'))});
	...
	$(document).on("change","#photoimg_product_edit",function(){validator("empty,formatImage",$(this).attr('id'))});
	$(document).on("click", "#btn_editar_producto_enviar", function() { //delegar
		if(validator("empty","editar_product_nombre") && validator("empty,number","editar_product_cantidad_inicial")  && validator("empty,number","editar_product_cantidad_restante") && validator("empty,number","editar_product_peso") && validator("empty,number","editar_product_tamano") && validator("empty,number","editar_product_precio") && validator("empty","editar_product_descripcion") && validator("empty,formatImage","photoimg_product_edit")){
			$(".error_datos_create_product").hide();
